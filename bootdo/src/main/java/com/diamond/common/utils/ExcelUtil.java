...
import com.diamond.common.annotation.Excel.ColumnType;
import com.diamond.common.annotation.Excel.Type;
import com.diamond.common.annotation.Excels;
...
public class ExcelUtil<T> {
    ...
    @Value("{diamond.uploadPath}")
    private static String path = "D:/ruoyi/uploadPath/";
    ...
    public String encodingFilename(String filename) {
        filename = UUID.randomUUID().toString() + filename + ".xlsx";
        return filename;
    }
    ...
    public String getAbsoluteFile(String filename) {
        String downloadPath = path + "_" + filename;
